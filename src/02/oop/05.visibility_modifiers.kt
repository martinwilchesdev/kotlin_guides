fun main() {
     /**
      * Los modificadores de accesibilidad son la caracteristica principal que permite lograr el encapsulamiento.
...
open class SmartDeviceVisibilityClass {
    ...
    var speakerVolume = 2
    // Los modificares de visibilidad tambien pueden ser configurados para las funciones set()
    protected set(value) {
        if (value in 0..100) {
            field = value
        }
    ...
    // Los modificadores de visibilidad tambien pueden ser especificados para metodos
    private fun turnOn() {
