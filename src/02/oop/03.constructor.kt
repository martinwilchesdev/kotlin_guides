fun main() {
    ...
    // El valor de las propiedades de la clase inicializadas en el constructor, saer definen durante el proceso de instanciacion.
...
class SmartDeviceConstructoClass(val name: String, val category: String) {
     ...
     *
     * Si la clase tiene un constructor principal, cada constructor secundario debe iniciarlizar el constructor secundario.
     *
